...
TEST(DynamiсArray, Constructor_4) {
    DynamicArray<int> array = DynamicArray<int>(pointer, 4);
...
TEST(DynamiсArray, GetSize) {
    DynamicArray<int> array = DynamicArray<int>( 4);
    EXPECT_EQ(array.GetSize(), 4);
}

TEST(DynamiсArray, Get) {
    DynamicArray<int> array = DynamicArray<int>(pointer, 4);
